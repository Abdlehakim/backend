...
router.get('/PostCardData', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield PostCategorie_1.default.find({});
        const Posts = yield Post_1.default.find({ vadmin: 'approve' }).select("title description imageUrl slug createdAt")
