 ...
 */
router.get("/:postCategorieId", (0, requireDashboardPermission_1.requirePermission)("M_Blog"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { postCategorieId } = req.params;
        const postCategorie = yield PostCategorie_1.default
