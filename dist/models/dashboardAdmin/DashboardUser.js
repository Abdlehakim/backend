...
DashboardUserSchema.pre('save', function (next) {
...
DashboardUserSchema.pre('validate', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const roleDoc = yield mongoose_1.default.model('DashboardRole').findById(this.role);
            if (roleDoc && roleDoc.name === 'SuperAdmin') {
                const count = yield mongoose_1.default
                    .model('DashboardUser')
...
DashboardUserSchema.methods.comparePassword = function (candidatePassword) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield bcrypt_1.default.compare(candidatePassword, this.password);
    });
};
const DashboardUser = mongoose_1.default.model('DashboardUser', DashboardUserSchema);
