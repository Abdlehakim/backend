 ...
 */
router.put("/update/:subCatId", (0, requireDashboardPermission_1.requirePermission)("M_Stock"), multer_1.memoryUpload.fields([
    ...
    if (!userId) {
        ...
        try {
            // 1) load existing
            const existing = yield SubCategorie_1.default.findById(subCatId);
            if (!existing) {
                ...
                const { name, slug, vadmin, categorie, } = req.body;
                ...
                if (typeof categorie === "string") {
                    updateData.categorie = new mongoose_1.default.Types.ObjectId(categorie);
                }
                ...
                if (iconFile) {
                    ...
                    const uploadedIcon = yield (0, uploadToCloudinary_1.uploadToCloudinary)(iconFile, "subcategories");
                ...
                if (imageFile) {
                    ...
                    const uploadedImage = yield (0, uploadToCloudinary_1.uploadToCloudinary)(imageFile, "subcategories");
                ...
                if (bannerFile) {
                    ...
                    const uploadedBanner = yield (0, uploadToCloudinary_1.uploadToCloudinary)(bannerFile, "subcategories");
                    updateData.bannerUrl = uploadedBanner.secureUrl;
                    updateData.bannerId = uploadedBanner.publicId;
                }
                // 6) apply update
                const updatedSubCat = yield SubCategorie_1.default.findByIdAndUpdate(subCatId, updateData, { new: true, runValidators: true });
                if (!updatedSubCat) {
                    res
                        .status(404)
