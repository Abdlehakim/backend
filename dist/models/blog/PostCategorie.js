...
const slugifyCategorieName = (name) => name
    ...
    .replace(/\s+/g, '-')
    .replace(/[^\w-]+/g, '');
const PostCategorieSchema = new mongoose_1.Schema({
...
PostCategorieSchema.pre('validate', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        if (this.isNew) {
            ...
            do {
                ...
                exists = yield mongoose_1.default.models.PostCategorie.findOne({ reference: ref });
            } while (exists);
            this.reference = ref;
        }
        next();
...
PostCategorieSchema.pre('save', function (next) {
...
const PostCategorie = mongoose_1.default.models.PostCategorie ||
    mongoose_1.default.model('PostCategorie', PostCategorieSchema);
exports.default = PostCategorie;
