...
const slugifyBoutiqueName = (name) => name
    .normalize("NFD")
    .replace(/[\u0300-\u036f]/g, "")
    .toLowerCase()
    .trim()
    .replace(/\s+/g, "-")
    .replace(/[^\w-]+/g, "");
const BoutiqueSchema = new mongoose_1.Schema({
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (this.isNew) {
            ...
            do {
                ...
                exists = yield mongoose_1.default.models.Boutique.findOne({ reference: ref });
            } while (exists);
            this.reference = ref;
        }
        next();
...
const Boutique = mongoose_1.default.models.Boutique ||
    mongoose_1.default.model("Boutique", BoutiqueSchema);
exports.default = Boutique;
